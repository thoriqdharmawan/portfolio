...
const LINKS = [
  { label: "GitHub", value: "github.com/thoriqdharmawan", href: "https://github.com/thoriqdharmawan" },
  { label: "LinkedIn", value: "linkedin.com/in/thoriq", href: "https://linkedin.com/in/thoriqdharmawan" },
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              fontSize: "clamp(120px, 30vw, 360px)", lineHeight: 0.8,
              color: "rgba(255,255,255,0.03)", letterSpacing: "-0.06em", whiteSpace: "nowrap",
            }}
          >
            say hi
          </div>
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            <h2
              className="font-display"
              style={{
                fontSize: "clamp(44px, 7vw, 110px)", lineHeight: 0.92,
                margin: "20px 0 0", fontWeight: 500, letterSpacing: "-0.04em", maxWidth: 900,
              }}
            >
              Let&apos;s build the<br />
              <span className="font-serif" style={{ color: ACCENT, fontWeight: 400 }}>next quietly</span><br />
              loud thing.
            </h2>

            <div style={{ display: "flex", gap: 16, marginTop: 50, flexWrap: "wrap", alignItems: "center" }}>
              <Magnet>
                <a href={`mailto:${EMAIL}`} className="btn btn-primary" style={{ padding: "18px 28px", fontSize: 15 }}>
                  {EMAIL}
              ...
              <button className="btn" onClick={copy} style={{ padding: "18px 24px", fontSize: 14 }}>
                {copied ? (
                  <>
            ...
            <div style={{ display: "flex", gap: 24, marginTop: 60, flexWrap: "wrap" }}>
              {LINKS.map(({ label, value, href }) => (
                ...
                >
                  ...
                  <span style={{ fontSize: 16, fontWeight: 400, transition: "color .25s" }}>{value}</span>
                </a>
              ))}
            </div>
          </div>
