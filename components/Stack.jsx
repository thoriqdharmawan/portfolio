...
const GROUPS = [
  { name: "Languages", keys: ["Typescript", "Python", "Javscript"] },
  {
    name: "Frontend",
    keys: [
      "NextJs",
  ...
  {
    name: "Backend & APIs",
    keys: ["Node.js", "Express.js", "Graphql", "WebSocket", "Hasura"],
  },
  { name: "Infra & Cloud", keys: ["PostgreSQL", "Redis", "SQL", "Docker", "AWS", "GCP"] },
  {
    name: "Mobile & AI",
    keys: ["React Native", "Expo", "OpenAI API", "LangChain"],
  },
    ...
    <section id="stack" style={{ borderTop: "1px solid var(--line)" }}>
      <div className="container">
        <div data-reveal style={{ marginBottom: 60, maxWidth: 720 }}>
          ...
          >
            Tools I keep coming back to — picked for predictable trade-offs, not
            hype.
          </p>
        </div>
